            ...
            <div class="row">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h1 class="panel-title">LISTES DES  FACTURES</h1>
                    </header>

                    <div class="panel-body">
                        <a class="btn btn-default mb-xs mt-xs mr-xs btn btn-default" id="btnventesimple"><i class="fa fa-plus"></i>Facturation</a>
                        ...
                        <table class="table table-bordered table-striped mb-none" id="venteTable" >
                            ...
                            <tr>
                                ...
                                <th class="center hidden-phone">Date la Facture</th>
...
@section('js')
    ...
    <script src="public/js/prestation.js"></script>
