            ...
            <div class="row">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h1 class="panel-title">LISTES DES  CATEGORIES</h1>
                    </header>
                            ...
                            <div class="tabs">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="produit" class="tab-pane">
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="form" action="" method="POST" class="	form-validate form-horizontal mb-lg" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group mt-lg">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select  name="categories" id="categories" class="form-control populate">
                                                            ...
                                                            <div class="form-group mt-lg">
                                                                <label class="col-sm-3 control-label">Nom</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="noms"  id="noms" class="form-control" placeholder="Tomate" required/>
                                        ...
                                        <table class="table table-bordered table-striped mb-none" id="produitTable" data-swf-path="public/octopus/assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                                            <thead>
                                            <tr>
