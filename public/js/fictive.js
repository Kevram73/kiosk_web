...
$('#valider').on('click',function (e) {
    Swal.fire({
        position: 'center',
        title: 'Voulez-vous créer une facture fictive ?',
        text:"",
        icon: 'warning',
                ...
                if (e.isDefaultPrevented()){
                    $.ajax({
                        ...
                        success : function(data) {
                            ...
                            if(data == 1)
                            {
                                sweetToast('success',"Facture générer !!!");
                                window.history.go(-1);
                                return false;
                            }else{
                                sweetToast('error',"Erreur lors de la création de la facture");
                            }
