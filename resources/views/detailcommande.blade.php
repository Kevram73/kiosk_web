...
@section('contenu')
    <div class="inner-wrapper">
        <section role="main" class="content-body">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">Type:<b> <span class="text-danger" id="sId"> {{$commande[0]->type == 1 ? 'COMMANDE DIRECTE' : 'COMMANDE NON LIVREE'}}</span> </b></li>
            ...
            <a class=" btn btn-default mb-xs mt-xs mr-xs btn btn-danger"  href="javascript:history.go(-1)"><i class="fa  fa-times"></i>Retour</a>
