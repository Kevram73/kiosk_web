                    ...
                    <div class="panel-body">
                        ...
                        <a class=" btn btn-default mb-xs mt-xs mr-xs btn btn-danger"  href="/retourvente-{{ $all_vente->id }}"><i class="fa fa-arrow-left"></i>Retour Vente</a>
                            @if (isset($retourVentes) && count($retourVentes) > 0)
                                ...
                                <table class="table table-bordered table-striped mb-none" id="afficheTable2" data-swf-path="public/octopus/assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf" >
                                    <thead>
                                    <tr>
