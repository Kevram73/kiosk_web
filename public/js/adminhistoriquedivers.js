...
$('#choix').on('change',function ( ) {
    if ($('#choix').val()=="mois"){
        ...
        $.ajax({
            url: '/adminanneedivers-'+ $('#boutique').val(),
            type: "get",
        ...
        $('#mois').on('change',function ( ) {
            $.ajax({
                url: '/admindiversmois-'+ $('#mois').val()+"-"+ $('#annee').val()+"-"+ $('#boutique').val(),
                type: "get",
                success: function (data) {
                    $('#depenses').val(data);
                },
            ...
            $(function () {
                achatTable=$('#achatTable').DataTable({
                    ...
                    ajax: '/adminrecupererdiversmois-'+ $('#mois').val()+"-"+ $('#annee').val()+"-"+ $('#boutique').val(),
                    "columns": [
        ...
        if ($('#choix').val()=="jour"){
            ...
            $('#an').hide();
            $.ajax({
                url: '/adminrecupererdatedivers-'+ $('#boutique').val(),
                type: "get",
                success: function (data) {
            ...
            $('#jour').on('change',function ( ) {
                $.ajax({
                    url: '/admindiversjour-'+ $('#jour').val()+"-"+ $('#boutique').val(),
                    type: "get",
                    success: function (data) {
                        $('#depenses').val(data);
                    },
                ...
                $(function () {
                    achatTable=$('#achatTable').DataTable({
                        ...
                        ajax: '/adminrecupererdiversdate-'+ $('#jour').val()+"-"+ $('#boutique').val(),
                        "columns": [
                            {data:"charge",name : 'charge'},
                            {data:"montant",name : 'montant'},
        ...
        if ($('#choix').val()=="an"){
            ...
            $('#annee').on('change',function ( ) {
                $('#depenses').val(null);
                $.ajax({
                    url: '/admindiversannee-'+ $('#annee').val()+"-"+ $('#boutique').val(),
                    type: "get",
                    success: function (data) {
                        $('#depenses').val(data);
                    },
                ...
                $(function () {
                    achatTable=$('#achatTable').DataTable({
                        ...
                        ajax: '/adminrecupererdiversannee-'+ $('#annee').val()+"-"+ $('#boutique').val(),
                        "columns": [
                            {data:"charge",name :'charge'},
                            {data:"montant",name :'montant'},
