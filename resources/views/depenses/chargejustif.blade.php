            ...
            <div class="row">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h1 class="panel-title">JUSTIFICATIF - {{$depense->libelle}} - {{$depense->montant}}</h1>
                    </header>
                            ...
                            <div class="col-md-6">
                                        ...
                                        <div class="form-group mt-lg">
                                            <div class="card-body col-md-12 col-sm-12">
												{{-- <img style="height: 500px; width: 600px;" src="{{ 'storage/'.$depense->justificatif_versement}}" class="img-responsive" alt="" />
 --}}
                         @if (!$depense->justificatif== null)

                                                <iframe style="height: 1000px;" src="{{ asset( 'justify/'.$depense->justificatif) }}" width="100%" height="500px"></iframe>
                                       @endif
                                       ...
                                       @endif
                                        <div class="modal-footer">
                                            <div class="col-md-12 text-right">
                                                <a href="/charges" class="mb-xs mt-xs mr-xs btn btn-default"><i class="fa fa-times"></i> Retour</a>
                                            </div>
                                        </div>
                            </div>
