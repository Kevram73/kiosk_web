        ...
        <section role="main" class="content-body">
            ...
            <div class="row">
                <section class="panel">
                    ...
                    <table class="table table-bordered table-striped mb-none" id="livraisonTable" data-swf-path="public/octopus/assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                        <thead>
                        <tr>
...
@section('js')
    ...
    <script src="public/js/newlivraisonvente.js"></script>
