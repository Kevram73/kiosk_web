            ...
            <div class="row">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h1 class="panel-title">LISTES DES  LIVRAISON DES VENTES</h1>
                    </header>

                    <div class="panel-body">
                        <a class="btn btn-default mb-xs mt-xs mr-xs btn btn-default" href="{{route('newlivraisonvente')}}"><i class="fa fa-plus"></i>Ajouter une livraison</a>
...
@section('js')
    ...
    <script src="public/js/livraisonvente.js"></script>
