                                ...
                                <div id="sommedebiteurs" class="tab-pane active">
                                 ...
                                 <a  class="modal-with-form btn btn-default mb-xs mt-xs mr-xs btn btn-default"  href="/addBulling">Ajouter Billetage </a>
                                   ...
                                   <div class="table-responsive">
                                           <table class="table table-bordered table-striped mb-none" id="detaillecaissenTable"  data-swf-path="public/octopus/assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                                               <thead>
                                                   <tr>
                                ...
                                <div id="reglements" class="tab-pane">
                                  ...
                                  <a  class="modal-with-form btn btn-default mb-xs mt-xs mr-xs btn btn-default"  href="/addBulling">Ajouter Billetage </a>
                                    ...
                                    <div class="table-responsive">
                                     ...
                                     <div class="table-responsive">
                                            <table class="table table-bordered table-striped mb-none" id="montantVersementTable"  data-swf-path="public/octopus/assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                                                <thead>
                                                    <tr>
                                                        <th class="center hidden-phone">Date</th>
