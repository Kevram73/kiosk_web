...
@section('contenu')
            ...
            <div class="row">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h1 class="panel-title">JUSTIFICATIF - {{$depense->name}} - {{$depense->depense_id}}</h1>
                    </header>
 ...
 --}}
                                                <iframe style="height: 1000px;" src="{{ asset( 'justify/'.$depense->url) }}" width="100%" height="500px"></iframe>
