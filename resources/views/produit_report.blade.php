                ...
                <div class="col-sm-6 col-md-8 col-lg-8 col-xl-8">
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <br>
                            <table class="table table-bordered table-striped mb-none" id="reportTable" data-swf-path="public/octopus/assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                                <thead>
                                <tr>
...
@section('js') 
    ...
    <script src="public/js/produit_report.js"></script>
    <script>
